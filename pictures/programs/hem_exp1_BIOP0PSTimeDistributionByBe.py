...
plt.xlabel('Value of Bit Exponent',fontsize=10) # ,fontsize=13
plt.ylabel('Time Proportion (%)',fontsize=10) # ,fontsize=13
plt.tick_params(direction='out',labelsize=8,length=4,width=1,top=False,right=False)
plt.legend(fontsize=8, loc=(0.05,1.01),ncol=4) #fontsize=6,frameon=False,loc='upper center',ncol=6

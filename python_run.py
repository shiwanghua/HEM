...
# width=0.9
# for i in range(9):
#     os.system('taskset -c 18 ./run '+str(expID)+' 20 5 '+str(width))
...
#    os.system('taskset -c 18 ./run '+str(expID)+' '+ str(atts)+ ' 5 0.5')

#include "constant.h"
string expID = "1459";       // Record the experiment ID number
...
int atts = 500;             // Total number of attributes, i.e. dimensions.
int attrGroup = 200;           // The number of attribute group in #atts attributes.

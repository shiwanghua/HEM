#include "constant.h"
string expID = "691";       // Record the experiment ID number
...
const double subp = 0.5;      // subp比例的订阅的谓词定义在前cons个维度上 in order to make the number of matching subscriptions > 0
...
int cons = 30;              // Number of constraints(predicates) in one sub.
int m = 30;                 // Number of constraints in one pub.

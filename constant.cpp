#include "constant.h"
string expID = "1649";             // Record the experiment ID number
...
const int valDis = 1;             // The distribution of values in subs and pubs. 0:uniform + fixed width | 1: random width >= $width + Uniform | 2: Zipf + random >=$width | 3: Normal + fixed width | 4: Normal + two ends

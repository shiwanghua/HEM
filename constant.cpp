#include "constant.h"
string expID = "1138";        // Record the experiment ID number
...
const int attNumType = 1;    // 0: Fixed size of sub and pub. 1: Random size of sub and pub, <= $cons and $m.
const int attDis = 1;        // The distribution of attributes in subs and pubs. 0:uniform distribution | 1:Zipf distribution | 2: sub Zipf, pub 满维

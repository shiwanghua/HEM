...
const int pubs = 1;       // Number of publications.
int atts = 5;             // Total number of attributes, i.e. dimensions.
const int cons = 3;        // Number of constraints(predicates) in one sub.
int m = 5;                 // Number of constraints in one pub. 所有事件的前cons维都有定�?

#include "constant.h"
string expID = "901";       // Record the experiment ID number
...
int attrGroup = 10;          // The number of attribute group in #atts attributes.
...
// HEM
int be = 0;                 // bit exponent. In each dimension, there are 2 * 2^{be} bitsets.
